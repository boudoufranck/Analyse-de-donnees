...
# création du dossier pour ranger les graphiques 

IMG_DIR = "graphiques_variables"
os.makedirs(IMG_DIR, exist_ok=True)

# Sauvegarde des figures créées
...
# Affichage moyennes et écarts-types 

...
#Chargement du fichier island-index.csv
print("\n" + "-"*60)
print("Importation du fichier island-index.csv")
print("-"*60)

iles = pd.DataFrame(ouvrirUnFichier("./data/island-index.csv"))
print(iles.head())

#Extraction colonne surfaces et ajout continents 
print("\n" + "-"*60)
print("Extraction des surfaces des îles")
print("-"*60)

surfaces = list(iles["Surface (km²)"])
surfaces = [float(x) for x in surfaces]   #typage en float
...
#Ordre décroissant 
print("\n" + "-"*60)
print("Tri décroissant des surfaces")
print("-"*60)
...
#Visualisation loi rang-taille
print("\n" + "-"*60)
print("Visualisation loi rang–taille")
print("-"*60)
...
print("\n" + "="*80)
print("POPULATIONS DU MONDE (RANGS ET CORRÉLATIONS)")
print("="*80 + "\n")

#Chargement du fichier populations
print("\n" + "-"*60)
print("Importation du fichier Le-Monde-HS-Etats-du-monde-2007-2025.csv")
print("-"*60)
...
print("\n" + "-"*60)
print("Colonnes à analyser : État, Pop 2007, Pop 2025, Densité 2007, Densité 2025")
print("-"*60)
...
#Classement décroissant populations et densités 
print("\n" + "-"*60)
print("Classement décroissant des populations et densités")
print("-"*60)
...
#Préparation comparaison classement pays
print("\n" + "-"*60)
print("Préparation de la comparaison des classements")
print("-"*60)
...
#Isolation deux colonnes pour corrélation 
print("\n" + "-"*60)
print("Isolation des rangs Pop 2007 et Densité 2007")
print("-"*60)
...
#Calcul corrélations rang
print("\n" + "-"*60)
print("Corrélation de rang (Spearman) et concordance (Kendall)")
print("-"*60)
